...
public class CustomAlertDialog {
    ...
    public void showInfoDialog(String title, String message) {
        showPreparedDialog(context.getResources().getColor(R.color.color_info), R.drawable.ic_info, title, message);
    }
    ...
    public void showSuccessDialog(String title, String message) {
        showPreparedDialog(context.getResources().getColor(R.color.color_success), R.drawable.ic_check_circle, title, message);
    }
    ...
    public void showErrorDialog(String title, String message) {
        showPreparedDialog(context.getResources().getColor(R.color.color_error), R.drawable.ic_error, title, message);
    }
    ...
    public void showWarningDialog(String title, String message, final OnClickListener btnYesOnClickListener) {
        int colorWarning = context.getResources().getColor(R.color.color_warning);
        ...
        setNegativeButton(context.getString(R.string.no),
                ...
                context.getResources().getColor(R.color.color_neutral), Color.WHITE);
        show();
    }
//--------------------------------------------------------------------------------------------------
    ...
    public void showInfoDialog(String message) {
        showPreparedDialogWithLargeIcon(R.drawable.ic_info, message,
                context.getResources().getColor(R.color.color_info));
    }
    ...
    public void showSuccessDialog(String message) {
        showPreparedDialogWithLargeIcon(R.drawable.ic_check_circle, message,
                context.getResources().getColor(R.color.color_success));
    }
    ...
    public void showErrorDialog(String message) {
        showPreparedDialogWithLargeIcon(R.drawable.ic_error, message,
                context.getResources().getColor(R.color.color_error));
    }
    ...
    public void showWarningDialog(String message, final OnClickListener btnYesOnClickListener) {
        setDialogWithLargeIcon(R.drawable.ic_warning, null, message);
        setPositiveButton(context.getString(R.string.yes), btnYesOnClickListener,
                context.getResources().getColor(R.color.color_warning), Color.WHITE);
        setNegativeButton(context.getString(R.string.no),
                new OnClickListener() {
                    @Override
                    public void onClick(CustomAlertDialog dialog) {
...
//--------------------------------------------------------------------------------------------------
     ...
     * Yazılımcının başlık atamadan ikon ataması durumunda başlık arka plan rengi dialog.xml
...
//--------------------------------------------------------------------------------------------------
     ...
     * arka plan rengi eksik görünüyordu. Eksik olan yerler dialog.xml'den gelen background_color
...
//--------------------------------------------------------------------------------------------------
    ...
    public CustomAlertDialog setDialogWithLargeIcon(final int iconResId, final String title, String message) {
        ...
        if (title != null) {
            ...
            // Fakat dialog.xml dosyasında txtTitle'ın 10dp'lik paddingStart'ı olduğu için tam ortalanmıyordu.
